...
\title[Robots Móviles 2025-2]{Robots Móviles\\(Temas Selectos de Control y Robótica)\\(Temas Selectos de Mecatrónica I y II)}
\author[Dr. Marco Negrete]{Dr. Marco Negrete}
\institute[FI, UNAM]{Facultad de Ingeniería, UNAM}
\date[2025-1]{Semestre 2025-1\\Material elaborado con apoyo del proyecto PAPIME PE105524}
...
\input{Tex/BasicConcepts.tex}
\input{Tex/ROS.tex}
\input{Tex/MotionPlanning.tex}
\input{Tex/Vision.tex}
\input{Tex/Manipulation.tex}
\input{Tex/NeuralNetworks.tex}
\input{Tex/Speech.tex}
