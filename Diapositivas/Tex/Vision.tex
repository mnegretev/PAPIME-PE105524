...
%%% 2025-03-20 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Conceptos de visión computacional (2025-03-20)}
...
\begin{frame}[containsverbatim]\frametitle{Tarea 10 - Segmentación por color}
...
%%% 2025-03-25 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Formas geométricas (2025-03-25)}

\begin{frame}\frametitle{Formas geométricas}
  \begin{itemize}
  \item El algoritmo RANSAC permite eliminar datos atípicos en subconjuntos de nubes de puntos
  \item El Análisis de Componentes Principales 
  \end{itemize}
\end{frame}
...
\begin{frame}[containsverbatim]\frametitle{Tarea 11 - Segmentación de rectas y planos}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-03-27 al inicio de la clase. 
\end{frame}
