...
%%% 2025-02-13 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Representación del ambiente (2025-02-13)}
...
\begin{frame}\frametitle{Celdas de ocupación}
  ...
  \begin{figure}
    ...
    \includegraphics[width=0.4\textwidth]{Figures/MotionPlanning/UniversumZoom.png}
    \end{figure}
...
\begin{frame}\frametitle{Mapas de líneas}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{Figures/MotionPlanning/MapLinesGazebo.png}
    \includegraphics[width=0.3\textwidth]{Figures/MotionPlanning/MapLines.png}
  \end{figure}
...
\begin{frame}\frametitle{Algoritmo \textit{Split and Merge}}
  ...
  \begin{columns}
    ...
    \begin{column}{0.35\textwidth}
      \includegraphics[width=\textwidth]{Figures/MotionPlanning/SplitAndMerge.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[containsverbatim]\frametitle{Tarea 03 - Representación del ambiente}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-02-18 al inicio de la clase. 
\end{frame}

%%%%%%%%%%%%%%%%%%%
%%% 2025-02-18 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Planeación de rutas (2025-02-18)}
...
\section{Planeación de rutas mediante RRT (2025-02-18)}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{algorithm}[H]
        \small
        \DontPrintSemicolon
        \KwData{Mapa, $p_{s} = $ Punto origen, $p_g=$ Punto meta }
        \KwResult{Ruta de $p_s$ a $p_g$}
        \;
        Árbol.Raíz = $p_{s}$\;
        \While{$padre(p_g) == Null \wedge intentos < N$ }
        {
          $p\leftarrow$ Punto aleatorio en el espacio libre\;
          $n\leftarrow$ Nodo más cercano a $p$\;
          $p_n\leftarrow ObtenerNuevoNodo(n,p, \epsilon)$\;
          \If{No hay colisión de $n$ a $p_n$}
          {
            Agregar $p_n$ como nodo hijo de $n$\;
            \If{No hay colisión de $p$ a $p_g$}
            {
              Agregar $p_g$ como nodo hijo de $p_n$\;
              Detener exploración
            }
          }
          $intentos++$\;
    ...
    \end{column}
    \begin{column}{0.5\textwidth}
      \textit{ObtenerNuevoNodo}:
      \begin{algorithm}[H]
        \footnotesize
        \DontPrintSemicolon
        \KwData{Nodo $n$, punto $p$ y distancia $\epsilon$}
        \KwResult{Nuevo punto $p_n$}
        \;
        \eIf{$d(n,p) > \epsilon$}
        {
          $p_n \leftarrow n + \epsilon\dfrac{p - n}{\left|p-n\right|}$
        }
        {
          $p_n \leftarrow p$
        }
      ...
      \end{algorithm}
      \[\]
      \textit{Obtener Ruta del Árbol de Exploración}:
      \begin{algorithm}[H]
        \footnotesize
        \DontPrintSemicolon
        \KwData{Árbol de exploración $T$, nodo meta $p_g$}
        \KwResult{Ruta $P$}
        \;
        \While{$padre(p_g)\neq NULL$}
        {
          Insertar $p_g$ al inicio de la ruta $P$\;
          $p_g \leftarrow parent(p_g)$
        }
        \Return $P$\;
      \end{algorithm}
    \end{column}
...
\begin{frame}\frametitle{\textit{Rapidly-exploring Random Trees}}
  \begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/MotionPlanning/RRTExample.pdf}
  \end{figure}
\end{frame}

\begin{frame}[containsverbatim]\frametitle{Tarea 04 - Planeación de rutas mediante RRT}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-02-20 al inicio de la clase. 
\end{frame}
...
%%% 2025-02-20 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Planeación de rutas mediante A* (2025-02-20)}
...
\begin{frame}\frametitle{El algoritmo A*}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{Figures/MotionPlanning/AStarExample.png}
  \end{figure}
\end{frame}
...
\begin{frame}[containsverbatim]\frametitle{Práctica 01 - Planeación de rutas}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-02-27 al inicio de la clase. 
\end{frame}

%%%%%%%%%%%%%%%%%%%
%%% 2025-02-25 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Modelos cinemáticos (2025-02-25)}
...
\begin{frame}\frametitle{Modelo cinemático}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figures/MotionPlanning/GoalPose.pdf}
      \end{figure}
    \end{column}
    \begin{column}{0.5\textwidth}
...
\begin{frame}\frametitle{Base omnidireccional de 4 ruedas}
  ...
  \begin{columns}
    \begin{column}{0.4\textwidth}
      \includegraphics[width=\textwidth]{Figures/MotionPlanning/Omnidirectional4wheels.pdf}
    \end{column}
    \begin{column}{0.6\textwidth}
      \[\left[\begin{array}{c}
        ...
        \]
  \begin{itemize}
  \item Las velocidades de las llantas son velocidades lineales (m/s).
...
\begin{frame}\frametitle{Base omnidireccional de 3 ruedas}
  ...
  \begin{columns}
    \begin{column}{0.4\textwidth}
      \includegraphics[width=\textwidth]{Figures/MotionPlanning/Omnidirectional3wheels.pdf}
    \end{column}
    \begin{column}{0.6\textwidth}
      \[\left[\begin{array}{c}
          v_1\\v_2\\v_3
...
\begin{frame}\frametitle{Base \textit{Ackermann}}
  \begin{columns}
    \begin{column}{0.7\textwidth}
      \begin{figure}
        \centering
        \includegraphics[height=0.5\textheight]{Figures/MotionPlanning/AckermannBase.pdf}
      \end{figure}
    \end{column}
...
\begin{frame}[containsverbatim]\frametitle{Tarea 05 - Modelos cinemáticos}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-02-27 al inicio de la clase. 
\end{frame}
...
%%% 2025-02-27 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Seguimiento de rutas (2025-02-27)}
...
\begin{frame}[containsverbatim]\frametitle{Tarea 06 - Seguimiento de rutas}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-03-04 al inicio de la clase. 
\end{frame}
...
%%% 2025-03-04 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Suavizado de rutas (2025-03-04)}
...
%%% 2025-03-06 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Suavizado de rutas (2025-03-06)} %Se hizo el cambio de fecha por la falta de tiempo por el propedeutico de PDS
\begin{frame}[containsverbatim]\frametitle{Práctica 02 - Navegación autónoma}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-03-13 al inicio de la clase. 
\end{frame}

%%%%%%%%%%%%%%%%%%%
%%% 2025-03-11 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Evasión de obstáculos (2025-03-11)}
...
%% \begin{frame}\frametitle{Tarea 06 - Mínimos locales}
%%   \begin{itemize}
%%   \item Considere la siguiente figura:
%%   \item Determine el punto $P_m=(x,y)$ en el que se producirá un mínimo local. Para el cálculo de las fuerzas repulsivas, considere los centroides de los obstáculos indicados en la figura.
%%   \item Calcule las fuerzas atractiva y repulsiva para el punto $P_m$ para verificar que se cancelan y por lo tanto, se producirá un mínimo local.
%%   \end{itemize}
%% \end{frame}
...
\begin{frame}[containsverbatim]\frametitle{Tarea 07 - Evasión de obstáculos}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-03-13 al inicio de la clase. 
\end{frame}
...
%%% 2025-03-13 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Localización (2025-03-13)}
...
\begin{frame}\frametitle{Algoritmo de estimación del EKF}
  \begin{figure}
    \centering
    \includegraphics[height=0.6\textheight]{Figures/MotionPlanning/EKF2.png}
  \end{figure}
  con:
  \begin{itemize}
...
\begin{frame}[containsverbatim]\frametitle{Tarea 08 - Filtro de Kalman Extendido}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-03-18 al inicio de la clase. 
\end{frame}
...
%%% 2025-03-18 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Filtro de Partículas (2025-03-18)}
...
\begin{frame}[containsverbatim]\frametitle{Tarea 09 - Filtros de partículas}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-03-20 al inicio de la clase. 
\end{frame}
...
%%% 2025-03-20 %%%%
%%%%%%%%%%%%%%%%%%%
\section{Implementación de un filtro de partículas (2025-03-18)}
\begin{frame}\frametitle{Implementación del filtro de partículas}
  \begin{itemize}
  \item La biblioteca \texttt{occupancy\_grid\_utils}
  \item Algoritmo para generar números aleatorios con una PDF dada
  \end{itemize}
\end{frame}

\begin{frame}[containsverbatim]\frametitle{Práctica 03 - Localización por filtros de partículas}
  Ver instrucciones en Classroom
  \[\]
  \textbf{Deadline: } 2025-03-27 al inicio de la clase. 
\end{frame}
