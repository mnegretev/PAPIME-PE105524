...
\begin{frame}[containsverbatim]\frametitle{Tarea 10 - Síntesis de voz}
  Ejecute el comando:
  \begin{lstlisting}
    roslaunch surge_et_ambula speech_synthesis.launch
  \end{lstlisting}
  En otra terminal, ejecute el comando:
  \begin{lstlisting}
    rosrun students assignment10.py "my first synthetized voice"
  \end{lstlisting}
...
\begin{frame}[containsverbatim]\frametitle{Tarea 10 - Síntesis de voz}
  Modifique el archivo \texttt{catkin\_ws/src/students/scripts/assignment10.py} y cambie la voz a utilizar en el mensaje SoundRequest.
...
\begin{frame}\frametitle{Tarea 11 - Reconocimiento de voz}
  \begin{enumerate}
  ...
  \item Ejecute el comando \texttt{roslaunch surge\_et\_ambula speech\_recognition.launch}
...
\begin{frame}\frametitle{Proyecto final: robot de servicio}
  \Large{Haga que el robot lleve un objeto de un lugar a otro}
\end{frame}
